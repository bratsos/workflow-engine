...
function rec(over: Partial<TaskRecord> = {}): TaskRecord {
  return {
    taskId: "t1", workflowRunId: "r1", stageId: "download", stageName: "D", stageNumber: 1,
    status: "PENDING", leaseToken: null, leasedAt: null, attempt: 0, deadline: 10_000, createdAt: 0,
    payload: { input: {}, config: {}, workflowContext: {} }, report: null, failureError: null, ...over,
  };
}
