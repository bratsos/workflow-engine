...
- Added to root: `ProviderResolver` (type), and the config-schema presets `withAIConfig`/`withConcurrency`/`withFeatureFlags`/`withStandardConfig` (plus their schemas and inferred types).
